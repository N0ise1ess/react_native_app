            ...
            renderRow={(item, sectionId, index) => (
              <View style={styles.advancedSearchWrapper}>
                ...
                <View style={[styles.operationButtons, styles.searchPickers]}>
                  <Button
                    rounded
                    style={[styles.button, styles.operationButton, item.operation === 'И...' && styles.activeOperation]}
                    onPress={() => this._handleOperationClick(index, 'И...')}
                  >
                  ...
                  <Button
                    ...
                    style={[
                      ...
                      item.operation === 'ИЛИ...' && styles.activeOperation,
                    ]}
                    onPress={() => this._handleOperationClick(index, 'ИЛИ...')}
                  >
                  ...
                  <Button
                    ...
                    style={[
                      styles.button,
                      styles.operationButton,
                      item.operation === 'КРОМЕ...' && styles.activeOperation,
                    ]}
                    onPress={() => this._handleOperationClick(index, 'КРОМЕ...')}
                  >
        ...
        {this.state.showResults ? (
          ...
          <Fragment>
            <View style={styles.upperButtons}>
              <Button style={[styles.upperButton, styles.buttonElectronic]}>{this._upperCase('Электронное')}</Button>
              <Button style={[styles.upperButton, styles.buttonPrinted]}>{this._upperCase('Печатное')}</Button>
            </View>
            <Tabs
...
export const LibrarySearchScreen = connect(mapStateToProps)(InnerComponent);
