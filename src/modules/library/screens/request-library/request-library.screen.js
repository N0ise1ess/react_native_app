import { Button, Container, Spinner, Text, Textarea } from 'native-base';
...
import { sendRequestLibrary, setRequestLibrary } from '../../store/library-actions';
...
class InnerComponent extends Component {
  ...
  _renderGeneralScreen = (styles) => (
    <React.Fragment>
      <View style={styles.text_block}>{this._upperCase('введите ключевые слова или запрос в свободной форме')}</View>
      <Textarea
  ...
  _renderThankYouPage = (styles) =>
    this.props.isLoadingRequestLibrary ? (
      <Spinner color="#blue" />
    ) : (
      <React.Fragment>
