...
class InnerComponent extends Component {
  ...
  renderSettings = (item, index) =>
    this.props.userStatus === 'guest' && (
      <View key={index} style={this.state.styles.row}>
        <View style={this.state.styles.col}>
          <Text style={this.state.styles.text}>{item.text}</Text>
        </View>
        <View style={[this.state.styles.col, this.state.styles.col__center]}>{this.renderSwitch(item.type)}</View>
      </View>
    );
    ...
    return (
      <Container style={styles.container}>
        <View style={styles.content}>
          <View style={styles.backgroundSettings}>{listSettings.map(this.renderSettings)}</View>
        </View>
